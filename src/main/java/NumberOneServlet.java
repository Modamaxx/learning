...
@WebServlet(name = "PrintServlet", urlPatterns = "/task")
public class NumberOneServlet extends HttpServlet {
    static Map<String, Integer> number1Counting = new HashMap<>();
    static Map<String, Integer> number2Counting = new HashMap<>();
